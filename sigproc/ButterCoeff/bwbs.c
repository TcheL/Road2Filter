 ...
 *                            COPYRIGHT
 *
 *  bwbs - Butterworth bandstop filter coefficient calculator
...
int main( int argc, char *argv[] )
{
    ...
    if( argc < 6 )
    {
	printf("\nbwbs calculates Butterworth bandstop filter coefficients\n");
	printf("\nUsage: bwbs n fc1 fc2 sf outfile\n");
    ...
    if( sff == 0 ) sf = 1.0;  // this prevents scaling if sff=0
